...
$execute if data storage cutscene:data cutscenes run tellraw @s [{"text":"  [Запустить]","color":"green","clickEvent":{"action":"suggest_command","value":"/function cutscene:cutscene/play {id:\"$(id)\"}"},"hoverEvent":{"action":"show_text","contents":"Нажмите для запуска"}},{"text":" "},{"text":"[Редактировать]","color":"yellow","clickEvent":{"action":"suggest_command","value":"/function cutscene:editor/open {id:\"$(id)\"}"},"hoverEvent":{"action":"show_text","contents":"Открыть редактор"}},{"text":" "},{"text":"[Удалить]","color":"red","clickEvent":{"action":"suggest_command","value":"/function cutscene:cutscene/delete {id:\"$(id)\"}"},"hoverEvent":{"action":"show_text","contents":"Удалить катсцену"}}]
