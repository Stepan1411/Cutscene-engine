...
execute if score localization l matches 1 run tellraw @s {"text":"🎨 Настройки шрифта Chat","color":"gold","bold":true}
execute if score localization l matches 1 run tellraw @s {"text":"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━","color":"gold"}
execute if score localization l matches 1 run tellraw @s ""
...
execute if score localization l matches 1 run tellraw @s ""
execute if score localization l matches 1 run tellraw @s [{"text":"[↩ Назад]","color":"gray","click_event":{"action":"run_command","command":"/function cutscene:edit/workspace_messages_chat_menu"}}]
execute if score localization l matches 1 run tellraw @s ""
...
execute if score localization l matches 2 run tellraw @s {"text":"🎨 Chat Font Settings","color":"gold","bold":true}
execute if score localization l matches 2 run tellraw @s {"text":"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━","color":"gold"}
execute if score localization l matches 2 run tellraw @s ""
...
execute if score localization l matches 2 run tellraw @s [{"text":"• ","color":"gray"},{"text":"Italic","italic":true},{"text":": ","color":"gray"}]
...
execute if score localization l matches 2 run tellraw @s ""
execute if score localization l matches 2 run tellraw @s [{"text":"[↩ Back]","color":"gray","click_event":{"action":"run_command","command":"/function cutscene:edit/workspace_messages_chat_menu"}}]
execute if score localization l matches 2 run tellraw @s ""
